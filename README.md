# activity-repport
Rapport d'activité (distanciel)

## 01 décembre 2025 — Activités du jour

### Travail sur le teaser du projet ESP
- Montage vidéo (sélection des plans, rythme, transitions)
- Voix off
- Intégration voix off + images
- Ajustements audio (nettoyage, équilibrage, synchronisation)
- Première version du teaser (1min) prête pour révision
